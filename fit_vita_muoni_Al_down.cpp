...
void fit_vita_muoni_Al_down() {
    ...
    // --- Funzione di fit ---
    TF1* fit = new TF1("fit_down", DoppioEsponenzialeFondoRetta, xMin, xMax, 5);
    ...
    fit->SetParLimits(3, 0.5, 0.9);   // tau_Al
    ...
    // --- Salvataggio grafico ---
    c->SaveAs("fit_muoni_Al_down.pdf");
    ...
    // --- Salva in CSV ---
    ofstream csv("correlation_matrix_Al_down.csv");
